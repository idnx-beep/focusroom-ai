...
export function TimerPanel({ pomodoro, setPomodoro, secondsLeft, isRunning, onStart, onPause, onReset, onEnd, compact = false }) {
  ...
  return (
    <div className={compact ? "text-center" : "min-w-0 rounded-3xl border border-white/12 bg-white/[0.07] p-4 sm:p-5"}>
      ...
      <div className="mx-auto grid aspect-square w-44 place-items-center rounded-full border border-white/15 bg-black/20 shadow-glow backdrop-blur-xl sm:w-64">
